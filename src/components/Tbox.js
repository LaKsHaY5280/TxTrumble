    ...
    <div style={{ color: props.mode === "light" ? "#333333" : "white" }}>
      ...
      <div className="mb-3">
        <textarea
          ...
          style={{
            backgroundColor: props.mode === "light" ? "white" : "rgb(19 29 38)",
            color: props.mode === "light" ? "#333333" : "white",
          }}
          value={txt}
          onChange={Writer}
          id="txtbox"
      ...
      <div>
        ...
        <p className="my-2" onChange={Writer}>
          ...
          Words and {txt.length} Characters <br />
          {0.008 * txt.split(" ").length} Minutes to read
        </p>
      </div>
      <div>
        <h2 className="my-3">Text Preveiw</h2>
        <p className="my-2">
          {txt.length > 0
            ? txt
            : "Enter some text in the above area to see the preveiw here..."}
        </p>
      </div>
      <div>
        <h1>history :</h1>
